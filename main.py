...
def run_gui():
    """Run the GUI version"""
    from desktop_monitor.gui import DesktopMonitorGUI
    
    try:
        app = DesktopMonitorGUI()
        app.run()
    except Exception as e:
        print(f"❌ Error starting Desktop Monitor GUI: {e}")
        import traceback
        traceback.print_exc()
        sys.exit(1)
...
def run_console():
    ...
    class DesktopMonitor:
        """Original console-based desktop monitoring application"""
        ...
        def __init__(self):
            ...
            self.yolo_trigger_cooldown = 5.0
...
def main():
    """Main entry point with GUI/console mode selection"""
    parser = argparse.ArgumentParser(description="Desktop Monitor - Multi-Modal Monitoring System")
    ...
    if args.console:
        print("Starting Desktop Monitor in console mode...")
        run_console()
    else:
